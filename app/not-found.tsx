  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center justify-center text-center px-6">
      ...
      <div className="-mt-8 relative z-10">
        ...
        <p className="mt-4 font-body text-base text-white/80 max-w-md mx-auto">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link href="/contact" className="inline-flex items-center px-8 py-4 border border-white/40 text-white font-body font-semibold text-sm uppercase tracking-widest hover:border-blue-link hover:text-blue-link transition-colors min-h-[44px]">
            Contact Us
          </Link>
        </div>
      </div>
